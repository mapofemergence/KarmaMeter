		...
		<div id="primary">
			<div id="content" role="main">
				...
				<fieldset>
					...
					<input type="text" name="lat"/>
					<label>user id</label>
					<input type="text" name="id_user" value="34672255"/>
					<label>creature id</label>
					<input type="text" name="id_creature" value="1"/>
					<a href="javascript:void(0);" id="insert_tag">Tag yourself!</a>
				</fieldset>	
				</form>
				<hr/>
				<br/>
...
$("#search_feed").click(function(){
	...
	$.post(base_url + "cosm_search_feed.php", 
		postdata,
...
$("#view_feed").click(function(){
	postdata = $(this).parent().serializeArray();
	$.post(base_url + "cosm_view_feed.php",
		postdata,
		function(data){$("#result").html(data);}//, "json" 
		);
});
